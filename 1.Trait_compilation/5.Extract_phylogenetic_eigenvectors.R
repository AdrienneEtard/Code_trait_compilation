...
# Reptiles
C_Reptiles$Longevity_d <- apply(C_Reptiles[, c("Longevity_d","Max_longevity_d")], 1, mean, na.rm=TRUE)
C_Reptiles <- C_Reptiles %>% select(-Max_longevity_d)
UN_Reptiles$Longevity_d <- apply(UN_Reptiles[, c("Longevity_d","Max_longevity_d")], 1, mean, na.rm=TRUE)
UN_Reptiles <- UN_Reptiles %>% select(-Max_longevity_d)
Cdf_UNphy_Reptiles$Longevity_d<- apply(Cdf_UNphy_Reptiles[, c("Longevity_d","Max_longevity_d")], 1, mean, na.rm=TRUE)
...
# Amphibians
colnames(C_Amphibians)[7] <- "Longevity_d"
colnames(UN_Amphibians)[7] <- "Longevity_d"
colnames(Cdf_UNphy_Amphibians)[7] <- "Longevity_d"
...
# Birds
C_Birds$Longevity_d <- apply(C_Birds[, c("Max_longevity_d","Longevity_d")], 1, mean, na.rm=TRUE)
C_Birds <- C_Birds %>% select(-Max_longevity_d)
UN_Birds$Longevity_d <- apply(UN_Birds[, c("Max_longevity_d","Longevity_d")], 1, mean, na.rm=TRUE)
UN_Birds <- UN_Birds %>% select(-Max_longevity_d)
Cdf_UNphy_Birds$Longevity_d <- apply(Cdf_UNphy_Birds[, c("Max_longevity_d","Longevity_d")], 1, mean, na.rm=TRUE)
...
# Mammals
C_Mammals$Longevity_d <- apply(C_Mammals[, c("Max_longevity_d","Longevity_d")], 1, mean, na.rm=TRUE)
C_Mammals <- C_Mammals %>% select(-Max_longevity_d)
UN_Mammals$Longevity_d <- apply(UN_Mammals[, c("Max_longevity_d","Longevity_d")], 1, mean, na.rm=TRUE)
UN_Mammals <- UN_Mammals %>% select(-Max_longevity_d)
Cdf_UNphy_Mammals$Longevity_d <-  apply(Cdf_UNphy_Mammals[, c("Max_longevity_d","Longevity_d")], 1, mean, na.rm=TRUE)
...
C_Reptiles <- C_Reptiles[, c(Taxinfo,
                         ...
                         "Litter_size", "Range_size_m2", "Diel_activity", "Trophic_level", "Diet_breadth", "Primary_diet", "Specialisation",
...
# hybrid files
write.csv(Cdf_UNphy_Amphibians, "../../Results/1.Traits_before_imputations/With_taxonomic_correction/All_species/3.with_phylo_eigenvectors/corrected_datasets_but_uncorrected_phylogenies//Amphibians.csv", row.names = FALSE)
write.csv(Cdf_UNphy_Birds, "../../Results/1.Traits_before_imputations/With_taxonomic_correction/All_species/3.with_phylo_eigenvectors/corrected_datasets_but_uncorrected_phylogenies/Birds.csv", row.names = FALSE)
write.csv(Cdf_UNphy_Mammals, "../../Results/1.Traits_before_imputations/With_taxonomic_correction/All_species/3.with_phylo_eigenvectors/corrected_datasets_but_uncorrected_phylogenies/Mammals.csv", row.names = FALSE)
write.csv(Cdf_UNphy_Reptiles, "../../Results/1.Traits_before_imputations/With_taxonomic_correction/All_species/3.with_phylo_eigenvectors/corrected_datasets_but_uncorrected_phylogenies/Reptiles.csv", row.names = FALSE)
