...
## Adding Elton traits, (a posteriori), for diel activity in birds
...
## Load trait data 
Mammals <- read.csv("../../Results/1.Traits_before_imputations/Without_taxonomic_correction/All_species/2.filtered/Mammals.csv")
Birds <- read.csv("../../Results/1.Traits_before_imputations/Without_taxonomic_correction/All_species/2.filtered/Birds.csv")
Amphibians <- read.csv("../../Results/1.Traits_before_imputations/Without_taxonomic_correction/All_species/2.filtered/Amphibians.csv")
Reptiles <- read.csv("../../Results/1.Traits_before_imputations/Without_taxonomic_correction/All_species/2.filtered/Reptiles.csv")
Reptiles$Maturity_d[Reptiles$Maturity_d==0] <- NA

## Predicts
PredictsVertebrates <- readRDS("../../Data/PREDICTS_database.rds") %>% 
...
# Saving results
write.csv(Reptiles, "../../Results/1.Traits_before_imputations/Without_taxonomic_correction/All_species/3.standardised/Reptiles.csv", row.names=FALSE)
write.csv(Mammals, "../../Results/1.Traits_before_imputations/Without_taxonomic_correction/All_species/3.standardised/Mammals.csv", row.names=FALSE)
write.csv(Birds, "../../Results/1.Traits_before_imputations/Without_taxonomic_correction/All_species/3.standardised/Birds.csv", row.names=FALSE)
write.csv(Amphibians, "../../Results/1.Traits_before_imputations/Without_taxonomic_correction/All_species/3.standardised/Amphibians.csv", row.names=FALSE)
