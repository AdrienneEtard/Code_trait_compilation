...
## Relevant for species that are not represented in the phylogeny initially
...
## BUT there are some branch length of 0 still because of addition of species to the root that did not generate polytomies
