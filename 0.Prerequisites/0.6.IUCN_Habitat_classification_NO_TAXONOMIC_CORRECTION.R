...
colnames(IUCN_mammal)[7] <- "Best_guess_binomial"
colnames(IUCN_amphibian)[7] <- "Best_guess_binomial"
colnames(IUCN_reptile)[7] <- "Best_guess_binomial"
colnames(IUCN_bird)[7] <- "Best_guess_binomial"
...
## Save files
write.csv(Habitat_amphibian, "../../Results/0.Processed_IUCN_Habitatdata/No_taxonomic_correction/Amphibians.csv", row.names = FALSE)
write.csv(Habitat_bird, "../../Results/0.Processed_IUCN_Habitatdata/No_taxonomic_correction/Birds.csv", row.names = FALSE)
write.csv(Habitat_reptile, "../../Results/0.Processed_IUCN_Habitatdata/No_taxonomic_correction/Reptiles.csv", row.names = FALSE)
write.csv(Habitat_mammal, "../../Results/0.Processed_IUCN_Habitatdata/No_taxonomic_correction/Mammals.csv", row.names = FALSE)
